...
#path = data to import, assuming a hardcoded directory
#output = whether locations (1) or velocities (2) are returned
#rm0 = remove trajectories with a median speed of 0 (typically dead ants or other inconsequential objects) from trajs (velocity); 1 removes, 0 keeps 
...
Import.single <- function(path, output = 2, rm0 = 1,
...
Process.single <- function(trajdat, output = 2, sconv = 0.05625, vconv = 0.28125){
